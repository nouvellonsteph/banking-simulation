/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f96515a7708c74b11b3eca857f31d785)
// Runtime types generated with workerd@1.20250424.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		TURNSTILE_SITE_KEY: "0x4AAAAAABXgDOr9knna9nPt";
		TURNSTILE_SECRET_KEY: "0x4AAAAAABXgDCSPusRc3MG29sYHQESlAro";
		NEXTJS_ENV: string;
		API_BASE_URL: string;
		COMPANY_NAME: string;
