// Generated by Wrangler by running `wrangler types` (hash: dd76967d6185c9348d5abb4019f8a2cb)
// Runtime types generated with workerd@1.20250321.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		API_BASE_URL: "https://virgin.sub.justalittlebyte.ovh";
		COMPANY_NAME: "Cloudflare Banking";
		COLOR_PRIMARY: "#f48120";
		NEXTJS_ENV: string;
		CONTAINER: DurableObjectNamespace /* MyContainer */;
		ASSETS: Fetcher;
	}
}
